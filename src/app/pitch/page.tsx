...
const thesis = [
  '今天行业里缺的不是更多 Agent，而是一个把记忆层、人格层、执行层连接起来，并把控制权交还给用户的终端。',
  'SoulShell 不替代 Claude Code、OpenClaw、Codex，也不替代 mem0、mem9、Second Me。',
  'SoulShell 做的是中间这一层：发现、编辑、注入，让用户主动管理 AI 的灵魂。',
];
      ...
      <main className="relative mx-auto flex w-full max-w-7xl flex-col px-6 pb-20 pt-8 sm:px-10 lg:px-12">
        ...
        <section className="mt-24">
          <SectionTitle
            ...
            body="Claude Code、OpenClaw、Codex、mem0、mem9、Second Me 这些系统分别证明了执行层、人格层、记忆层的成立。但它们还没有被统一成一个用户可以主动理解、编辑、迁移的灵魂界面。"
          />
        ...
        <section className="mt-24">
          <SectionTitle
            ...
            title="这次我没有试图做完整未来，而是先验证最关键的一刀"
