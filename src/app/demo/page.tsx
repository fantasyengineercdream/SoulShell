    ...
    return (
      <div className="h-screen w-screen overflow-y-auto bg-[#fff8ef] relative">
        <div className="absolute right-4 top-4 z-20 flex items-center gap-2">
          <Link href="/" className="inline-flex items-center rounded-full border border-amber-200 bg-white/85 px-4 py-2 text-sm font-bold text-amber-900 shadow-sm transition hover:bg-amber-50">展示页</Link>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center max-w-2xl mx-auto px-6 py-12">
          ...
          <div className="w-full rounded-2xl border border-amber-200 bg-white/70 px-5 py-4 text-center shadow-sm mb-6">
            <p className="text-[11px] font-bold uppercase tracking-[0.22em] text-amber-700">Local Demo Notice</p>
            <p className="mt-2 text-sm leading-7 text-stone-700">
              这个 demo 的文件发现、编辑和注入，依赖你本机上的 Claude Code / OpenClaw 文件结构。
              <span className="font-bold text-amber-900">云端部署只能展示界面，真正跑通需要本地部署。</span>
            </p>
          </div>
